...
type ContractDisputeDialogProps = {
  open: boolean
...
const presets = [
  "Заказчик не принимает выполненную работу",
  "Заказчик задерживает оплату этапа",
  "Заказчик изменил требования без согласования",
  "Заказчик не выходит на связь",
]

export const ContractDisputeDialog = ({
  open,
  onOpenChange,
  onConfirm,
}: ContractDisputeDialogProps) => {
