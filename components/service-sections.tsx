...
const recentRequests = [
  { title: "Нужна разработка интернет-магазина на Bitrix", budget: "150 000 ₽", city: "Москва", time: "5 мин назад", offers: 3, Icon: Monitor },
  { title: "SEO оптимизация сайта B2B компании", budget: "30 000 ₽/мес", city: "Казань", time: "12 мин назад", offers: 7, Icon: TrendingUp },
  { title: "Юридическое сопровождение слияния ООО", budget: "Договорная", city: "СПб", time: "23 мин назад", offers: 2, Icon: Scale },
  { title: "Грузоперевозка Москва–Новосибирск 10 тонн", budget: "45 000 ₽", city: "Москва", time: "31 мин назад", offers: 9, Icon: Truck },
  { title: "Бухгалтерский учёт для ИП на УСН", budget: "12 000 ₽/мес", city: "Екб", time: "45 мин назад", offers: 14, Icon: BarChart2 },
  { title: "Разработка фирменного стиля для стартапа", budget: "60 000 ₽", city: "Москва", time: "1 ч назад", offers: 5, Icon: Palette },
]
