...
export const AdminProposalDetailSections = ({
  ...
  <div className="space-y-5">
    <section id="supplier" className={sectionClassName}>
      <h2 className="mb-5 text-lg font-black">Supplier</h2>
      {proposal.supplier ? (
    ...
    <section id="price" className={sectionClassName}>
      <h2 className="mb-5 text-lg font-black">Price</h2>
      <dl className="grid gap-4 sm:grid-cols-2">
        <div>
          <dt className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">
            Сумма
    ...
    <section id="attachments" className={sectionClassName}>
      <h2 className="mb-5 text-lg font-black">Attachments</h2>
      {proposal.attachment ? (
        <a
    ...
    <section id="contract" className={sectionClassName}>
      <h2 className="mb-5 text-lg font-black">Contract</h2>
      {proposal.contract ? (
        <dl className="grid gap-4 sm:grid-cols-2">
          <div>
            <dt className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">
          ...
          <div>
            ...
            <dd className="mt-1 text-sm font-medium">{proposal.contract.status}</dd>
          </div>
          <div>
            <dt className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">
              Сумма
